...
@Configuration
@EnableHazelcastRepositories(basePackages = "com.geeklib.ether")
public class HazelcastConfiguration {
    ...
    private Set<Class<?>> listMapEntity() {
        ...
        Set<Class<?>> entities = reflections.getTypesAnnotatedWith(com.geeklib.ether.common.annotation.Entity.class);
